...
const copyAssetsMacos = require('./copy-assets/macos');
const cleanAssetsMacos = require('./clean-assets/macos');
...
module.exports = ({
  ...
  const platforms = {
    ...
    macos: {
      enabled: unl(mergePlatforms.macos.enabled, true),
      assets: mergePlatforms.macos.assets,
    },
  };
  ...
  [
    ...
    {
      name: 'macOS',
      enabled: platforms.macos.enabled,
      assets: platforms.macos.assets,
      manifest: getManifest(macosPath),
      config: config.macos,
      cleanAssets: cleanAssetsMacos,
      copyAssets: copyAssetsMacos,
      linkOptionsPerExt: {
        otf: linkOptionsPerExt.otf.macos,
        ttf: linkOptionsPerExt.ttf.macos,
        png: linkOptionsPerExt.png.macos,
        jpg: linkOptionsPerExt.jpg.macos,
        gif: linkOptionsPerExt.gif.macos,
        mp3: linkOptionsPerExt.mp3.macos,
      },
      otherLinkOptions: otherLinkOptions.macos,
    },
  ]
